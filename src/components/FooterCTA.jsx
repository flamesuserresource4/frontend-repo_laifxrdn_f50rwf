  ...
  return (
    <section id="team" className="relative py-24">
      <div className="pointer-events-none absolute inset-0 opacity-40 [mask-image:radial-gradient(60%_60%_at_50%_20%,black,transparent)]">
        <div className="absolute top-10 left-10 h-64 w-64 rounded-full bg-emerald-500/30 blur-3xl" />
        <div className="absolute bottom-10 right-10 h-56 w-56 rounded-full bg-fuchsia-500/30 blur-3xl" />
      </div>
          ...
          {team.map((m) => (
            ...
            >
              <div className="mb-4 flex items-center gap-3">
                <div className="h-10 w-10 rounded-xl bg-gradient-to-tr from-white/20 to-white/5 grid place-items-center">
              ...
              <p className="text-sm text-white/70">Focused on impact, speed, and clarity. We collaborate closely with your team to make growth predictable.</p>
            </motion.div>
          ))}
        </div>
      </div>
...
function CTASection({ onCtaClick }) {
  return (
    <section id="cta" className="relative py-24">
      <div className="mx-auto max-w-7xl px-6">
        <div className="overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-8 md:p-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
            ...
            <div className="flex md:justify-end">
              <a href="#cta" onClick={(e) => { e.preventDefault(); onCtaClick?.(e); }} className="group inline-flex items-center gap-2 rounded-full bg-white px-5 py-3 text-black font-medium hover:bg-white/90">
